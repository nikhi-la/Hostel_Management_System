                ...
                <form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
                    <center>
                        <table width="1200" border="1" cellpadding="10">
                            ...
                            <?php
                             $selRequest = "select * from tbl_messfee mf inner join tbl_hostelrentpayment hp on mf.user_id=hp.user_id inner join tbl_parent p on p.student_id=hp.user_id where p.user_id='".$_SESSION["user_id"]."' and mf.month=hp.hostelrent_month and mf.year=hp.hostelrent_year order by year desc,month asc";
                             //echo $selRequest;
