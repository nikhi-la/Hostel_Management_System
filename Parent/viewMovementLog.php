                    ...
                    <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <table  border="1" cellpadding="10">
                            ...
                            <?php
                             ...
                             {
                                $SelQry = "select * from tbl_movement m inner join tbl_parent p on m.user_id=p.student_id where p.user_id='" . $_SESSION["user_id"] . "' and out_date='".$_POST["searchdate"]."' or in_date='".$_POST["searchdate"]."' order by movement_id desc";
                             }
                             else{
                                $SelQry = "select * from tbl_movement m inner join tbl_parent p on m.user_id=p.student_id where p.user_id='" . $_SESSION["user_id"] . "' order by movement_id desc";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {
                                            ?><p style="color: var(--accent-color);"><?php echo "Returned";?></p><?php
                                        }else
                                        {
                                            ?><p style="color:red;"><?php echo "Not Returned";?></p>
                                        <?php
                                        }?>
                                    </td>
                                </tr>
