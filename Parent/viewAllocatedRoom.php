...
$userSelQry = "SELECT * FROM tbl_parent WHERE user_id='" . $_SESSION["user_id"] . "' AND verification_status=1 OR verification_status=3 ";
...
?>
    <?php
    $selQry = "SELECT * FROM tbl_roompreference rp INNER JOIN tbl_room r ON rp.room_id = r.room_id  INNER JOIN tbl_parent p ON rp.user_id=p.student_id AND p.user_id='" . $_SESSION["user_id"] . "'";
