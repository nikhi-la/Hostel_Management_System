                    ...
                    <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <table  border="1" cellpadding="10">
                            ...
                            <?php
                             ...
                             {
                                $SelQry = "select * from tbl_leave l inner join tbl_parent p on l.user_id=p.student_id where p.user_id='".$_SESSION["user_id"]."' and l.leave_status=1 and '".$_POST["searchdate"]."' between from_date and to_date order by leave_id desc";
                               
                             }
                             else{
                                $SelQry = "select * from tbl_leave l inner join tbl_parent p on l.user_id=p.student_id where p.user_id='".$_SESSION["user_id"]."' and l.leave_status=1 ";
