...
if(isset($_POST["btnpay"])){
  $updateQry="update tbl_student set caution_deposit_status=1,caution_payed_date=curdate() where user_id='".$_SESSION["user_id"]."'";
