                ...
                <section id="services" class="services section light-background">
                    <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <table width="600" border="1" cellpadding="10">
                            ...
                            <?php
                            $SelQry = "select * from tbl_attendance where user_id='" . $_SESSION["user_id"] . "' and attendance_date='".$_POST["searchdate"]."' order by attendance_date desc";
                ...
                <section id="services" class="services section light-background">
                    <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <table width="600" border="1" cellpadding="10">
                            ...
                            <?php
                            $SelQry = "select * from tbl_attendance where user_id='" . $_SESSION["user_id"] . "' order by attendance_date desc  LIMIT 15";
                            $row = $con->query($SelQry);
