...
include("Assets/Connection/Connection.php");
  if(!isset($_SESSION["user_id"]) || $_SESSION["user_type"]=="warden")
  {
    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="Guest/newStudent.php" style="color:green;"><b>Register</b></a></li>
        </ul>
    ...
    //       window.location="Student/payCautionDeposit.php";
    //     </script>
       <?php
    //   }
    ?>
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Fees</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="Student/viewPreviousBills.php">Bills</a></li>
              <li><a href="Student/payCautionDeposit.php">Caution Deposit</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown"><a href="#"><span>Profile</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li><a href="Student/changePassword.php">Change Password</a></li>
              <li><a href="Student/vacating.php">Vacate</a></li>
            </ul>
          </li>
        </ul>
        <i class="mobile-nav-toggle d-xl-none bi bi-list"></i>
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Profile</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="Student/myProfile.php">My Profile</a></li>
              <li><a href="Parent/changePassword.php">Change Password</a></li>
            </ul>
          </li>
        </ul>
        <i class="mobile-nav-toggle d-xl-none bi bi-list"></i>
