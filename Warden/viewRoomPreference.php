                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                    <?php
      $selRequest="select * from tbl_roompreference rp inner join tbl_student s inner join tbl_room r on rp.user_id=s.user_id and rp.room_id=r.room_id and rp.room_verification_status=1";
